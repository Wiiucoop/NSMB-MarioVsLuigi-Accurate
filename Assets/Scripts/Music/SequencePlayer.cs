...
public class SequencePlayer : MonoBehaviour
{
    ...
    [SerializeField] public List<SequenceData> songs;
    [SerializeField] public List<int> chances;

    private readonly WeightedList<SequenceData> weightedList = new();

    [NonSerialized] public SequenceData currentSong;
    ...
    public void SwitchToSong(SequenceData newSong, bool startPlayback = false)
    {
        player.Stop();
